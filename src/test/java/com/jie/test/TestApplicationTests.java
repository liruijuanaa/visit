...
class TestApplicationTests {
    ...
    public static MimeMessage createSimpleMail(Session session, String mailfrom, String mailTo, String mailTittle,
        ...
        void testQuery(){
            ...
            //yuyue.setGuestdate("2020-10-14");
            yuyue.setGuestname("111");
            List<Yuyue> list=new ArrayList<>();
            list = this.yuyueService.queryAll(yuyue);
            for(int i=0;i<list.size();i++){
                System.out.println("查询1条");
    ...
    void testInsert(){
            Yuyue yuyue =new Yuyue();
            yuyue.setGuestdate("2020-10-15");
            //yuyue.setApplyname("xixixi");
            yuyue.setTitle("hai");
